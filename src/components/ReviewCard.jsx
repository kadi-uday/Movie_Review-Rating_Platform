...
const ReviewCard = ({
  ...
  // Local state for user actions on this review
  ...
  // Toggle Helpful
  const toggleHelpful = () => {
    if (userActions.helpful) {
      setHelpfulCount(helpfulCount - 1);
    } else {
      setHelpfulCount(helpfulCount + 1);
      if (userActions.dislike) {
        setDislikeCount(dislikeCount - 1);
        setUserActions((prev) => ({ ...prev, dislike: false }));
      }
    }
    setUserActions((prev) => ({ ...prev, helpful: !prev.helpful }));
  };
  ...
  const toggleDislike = () => {
    if (userActions.dislike) {
      ...
      if (userActions.helpful) {
        setHelpfulCount(helpfulCount - 1);
        setUserActions((prev) => ({ ...prev, helpful: false }));
      }
    }
    setUserActions((prev) => ({ ...prev, dislike: !prev.dislike }));
  };
  ...
  return (
    <Card
      className="
        bg-white dark:bg-gray-900/80 border border-gray-200 dark:border-none
        ...
        <div className="flex flex-wrap items-center justify-between gap-2">
          <div className="flex flex-wrap items-center space-x-3">
            <Button
              ...
              className={`
                ...
                dark:bg-blue-900/30 dark:text-blue-400 dark:border-none
                hover:bg-blue-100 hover:text-blue-700
                dark:hover:bg-blue-800/50 dark:hover:text-blue-300
            ...
            <Button
              ...
              className={`
                ...
                dark:bg-red-900/20 dark:text-red-400 dark:border-none
          ...
          {!isOwnReview && !userActions.reported && (
            <Button
              ...
              className={`
                rounded px-2 py-1 text-gray-500 bg-gray-100 border border-gray-200
                dark:text-gray-400 dark:bg-gray-800/50 dark:border-none
